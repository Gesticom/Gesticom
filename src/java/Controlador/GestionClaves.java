 ...
 * @author Washington
 */
public class GestionClaves extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        SesionDAO Sesion = new SesionDAO();
          ...
          String sujeto ="Recordatorio Contraseña";
          String mensaje ="Su nombre de Usuario es : "+ObjDto.getUsuario()+ "  Su Clave : "+ObjDto.getContrasena() ;
          Mailer.send(ObjDto.getEmail(), sujeto, mensaje);  
