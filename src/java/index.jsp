	...
	<body>
		<main>
			...
			<div id="contenido">	
                    ...
                    <section>
                        <br>
	                  <form id="formularioRegistro" method="post"  action="Sesion">
	                        <div id="registro">
		                <h3><span class="fa fa-user">  Login</h3>
                            	<table class="table table-bordered table-striped" border=3>
		                        	...
		                        	<br>
		                        	<td><label for="txtclave">Digite su contrase馻 :</label>
		                        	<td><input type="password" name="txtclave" tabindex="2" required></td><tr>
	                        	</table>
                                <a href="solicitudempleados.html">Usuario nuevo</a>
	                        </div>
                                <p id="admin"></p>
	                        ...
	                        <script>
                                ...
                                <div id="pie"><a href="AboutGesticom.jsp">Versi髇 1.0 | COPYRIGHT  	&copy;2014 GESTICOM | Cont醕tenos: 3133163023</a></div>
...
<!--
                              ...
                              <div id="radio">
                               ...
                               <label1 class="radio-inline" for="admin">Administrador
                                ...
                                <p style="text-align: center; margin: 20px;"><button type="submit" class="btn btn-success boton" onclick="escogeperfil()" tabindex="4">Iniciar Sesi髇</button></p>
                                </div>
                    ...
                    <script>
                        $().ready(function() {
                            $("#formularioRegistro").validate({ 
                                ...
                                // Mensajes a generar para indicar al usuario la estructura valida que debe ingresar. Se debe indicar por cada regla adicionada anteriormente para sobre escribir los mensajes por defecto (los cuales est谩n en ingl茅s. Se encuentran en "jquery.validate.js" l铆nea 308)
                                messages: {
                                    nombreusuario: {
                                        required: "Campo requerido",
                                        minlength: "M韓imo {0} caracteres",
                                        maxlength: "M醲imo {0} caracteres"
                                    },
                                    clave: {
                                        required: "Campo requerido",
                                        minlength: "M韓imo {0} caracteres",
