        ...
        <main>
            ...
            <div id="contenido">	
                ...
                <section>
                    ...
                    <form id="formularioCargo" method="post" action="GestionCargos">
                        <div id="Cargos">
                            ...
                            <table class="table table-condensed" border=3>
                                ...
                                <td><input type="text" name="Id_Cargo" id="Id_Cargo"  ></td><tr>

                                    <td><label for="Cargo">Cargo</label>
                                    <td><input name="Cargo" id="Cargo" type="text"  >


                            </table>  
                            <input type="submit" class="btn btn-success" name="Boton" value="Cargo Nuevo" />
                    ...
                    %>
                    <script type="text/javascript"> alert("Cargo Registrado Correctamente")</script>
