            ...
            <div id="contenido">	
                ...
                <section>
                    ...
                    <%
                        ...
                        CampanaDAO camdao = new CampanaDAO();
                        CampanaDTO camdto = new CampanaDTO();
                        camdto = camdao.consultarUnRegistro1(Posi);
                    %>

                    <form name="formularioActualizacionUsuarios" action="GestionCampanas" method="POST">
                        <div id="Usuarios1">
                            ...
                            <table class="table table-condensed" border=3>
                                ...
                                <td><label for="Id_Campana">Id:</label>
                                <td><input type="text" name="Id_Campana" id="Id_Campana" value="<%if(camdto!=null){out.print(camdto.getId_Campana());}%>"> </td><tr>

                                    <td><label for="Campana">Campaña:</label>
                                    <td><input name="Campana" id="Campana" type="text"  value="<%if(camdto!=null){out.print(camdto.getCampana());}%>">
