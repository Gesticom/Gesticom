            ...
            <div id="contenido">	
                <div id="header">
                    <ul class="nav">
                        ...
                        <li><a class="btn btn-primary" href="campanasListar.jsp"><i class="fa fa-briefcase fa-fw"></i> CampaÒas</a>
                            <ul>
                ...
                <section>
                    ...
                    <form id="formularioCiudad" method="post" action="GestionCampanas">
                        <div id="Ciudades">
                            ...
                            <table class="table table-condensed" border=3>
                                ...
                                <td><input type="text" name="Id_Campana" id="Id_Campana"  ></td><tr>

                                    <td><label for="Campana">Campana</label>
                                    <td><input name="Campana" id="Campana" type="text"  >


                            </table>  
                            <input type="submit" class="btn btn-success" name="Boton" value="CampaÒa Nueva" />
